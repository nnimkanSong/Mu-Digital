    ...
    <div className="min-h-screen bg-[#0f0c29] bg-gradient-to-b from-[#0f0c29] via-[#1a1a2e] to-[#0f0c29] flex flex-col items-center justify-center px-4 py-10 relative overflow-hidden font-serif">
      ...
      <div className="z-10 w-full max-w-7xl">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-purple-300/60 tracking-[0.25em] text-[10px] sm:text-sm uppercase">
        ...
        <div className="flex flex-col md:flex-row gap-6 sm:gap-12 justify-center items-stretch">
          ...
          <button onClick={() => selectGender('ชาย')} className="group relative flex-1 flex flex-col items-center p-5 sm:p-10 rounded-[2.5rem] border border-white/5 bg-white/[0.02] backdrop-blur-2xl transition-all duration-700 hover:bg-blue-900/10 hover:border-blue-500/40 hover:-translate-y-4 hover:shadow-[0_20px_80px_rgba(59,130,246,0.2)]">
            <div className="relative w-full aspect-[3/4] max-h-[50vh] flex items-center justify-center overflow-visible cursor-pointer">
              ...
              <Image src="/male.svg" alt="Male" fill className="relative z-10 object-contain filter drop-shadow-[0_20px_30px_rgba(0,0,0,0.7)] group-hover:scale-110 transition-transform duration-700" />
            </div>
            <div className="mt-8 text-center">
              <span className="text-xl sm:text-4xl font-light tracking-widest text-blue-200 group-hover:text-blue-400 transition-all">ชาย</span>
          ...
          <button onClick={() => selectGender('หญิง')} className="group relative flex-1 flex flex-col items-center p-5 sm:p-10 rounded-[2.5rem] border border-white/5 bg-white/[0.02] backdrop-blur-2xl transition-all duration-700 hover:bg-pink-900/10 hover:border-pink-500/40 hover:-translate-y-4 hover:shadow-[0_20px_80px_rgba(236,72,153,0.2)]">
            <div className="relative w-full aspect-[3/4] max-h-[50vh] flex items-center justify-center overflow-visible cursor-pointer">
              ...
              <Image src="/female.svg" alt="Female" fill className="relative z-10 object-contain filter drop-shadow-[0_20px_30px_rgba(0,0,0,0.7)] group-hover:scale-110 transition-transform duration-700" />
            </div>
            <div className="mt-8 text-center">
              <span className="text-xl sm:text-4xl font-light tracking-widest text-pink-200 group-hover:text-pink-400 transition-all">หญิง</span>
